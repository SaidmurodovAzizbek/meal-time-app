      ...
      <div style={{ maxWidth: "600px", margin: "0 auto", background: "rgba(255,255,255,0.7)", backdropFilter: "blur(20px)", borderRadius: "24px", padding: "32px", border: "1px solid rgba(255,255,255,1)", boxShadow: "0 12px 32px rgba(34,197,94,0.06)" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          <div>
             ...
             <input type="text" defaultValue="Aliyev Vali" style={{ width: "100%", padding: "16px", borderRadius: "16px", border: "1px solid rgba(22,163,74,0.2)", background: "white", fontSize: "15px", outline: "none", color: "#1a3a2a", fontWeight: 600 }} />
          </div>
          <div>
             <label style={{ display: "block", fontSize: "13px", color: "#6b8f7b", fontWeight: 700, marginBottom: "8px" }}>Telefon raqam</label>
             <input type="text" defaultValue="+998 00 123 45 67" disabled style={{ width: "100%", padding: "16px", borderRadius: "16px", border: "1px solid rgba(0,0,0,0.05)", background: "#f9fafb", fontSize: "15px", outline: "none", color: "#9ca3af", fontWeight: 600 }} />
          </div>
          <div>
        ...
        <button style={{ width: "100%", marginTop: "32px", background: "#16a34a", color: "white", padding: "18px", borderRadius: "16px", border: "none", fontSize: "16px", fontWeight: 800, cursor: "pointer", boxShadow: "0 8px 24px rgba(22,163,74,0.25)" }} onClick={() => navigate("/home?tab=profile")}>
          Saqlash
        </button>
      </div>
    </div>
