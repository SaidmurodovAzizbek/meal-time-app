  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      const res = await fetch("http://localhost:8000/auth/send-otp", {
        ...
        // is_register: false
        body: JSON.stringify({ phone_number: values.phone, is_register: false }),
      })
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2 text-center">
        <h1 className="text-2xl font-bold tracking-tight text-gray-900">Profilingizga kiring</h1>
      ...
      <div className="mt-6 text-center text-sm">
        ...
        <Link to="/auth/register" className="text-emerald-600 hover:text-emerald-700 font-semibold hover:underline">
          Ro'yxatdan o'ting
        </Link>
      </div>
    </div>
